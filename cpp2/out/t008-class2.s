...
move	$a0, $t9
syscall
____len_to_new_line1____:
lb $t2, ($a0)
li $t3, 10
beq $t2, $t3, ____endofreadline1____
addi $a0, $a0, 1
b ____len_to_new_line1____
...
move	$a0, $t9
syscall
____len_to_new_line2____:
lb $t2, ($a0)
li $t3, 10
beq $t2, $t3, ____endofreadline2____
addi $a0, $a0, 1
b ____len_to_new_line2____
____endofreadline2____:
sb $zero, ($a0)
addi $sp, $sp, -4
sw $ra, ($sp)
lw $t9, tempo16
...
lb $t2, ($a0)
li $t3, 10
beq $t2, $t3, ____endofreadline3____
addi $a0, $a0, 1
b ____len_to_new_line3____
____endofreadline3____:
sb $zero, ($a0)
addi $sp, $sp, -4
sw $ra, ($sp)
lw $t9, tempo23
